...
-- ----------------------------------------------------------------------------
-- pending_pantry_items  (queue of scanned items awaiting review)
...
FROM (VALUES
    ...
    ('0007680839114',       'Cheddar Cheese',       200,         'g',         4.99,          'pending'),
    ('0083783375213',       'Basmati Rice',         900,         'g',         5.29,          'processing'),
